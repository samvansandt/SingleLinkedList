...
//  int[] test5 = {3, 7, 7, 7, 4, 5, 5, 2, 0, 8, 8, 8, 8, 5};
 ...
 //  x = head;  
//  while (x != null){
 //   System.out.println("Node.item is: " + x.item);
  //  x = x.next;
//}
  }
  }  
  ...
  public void twin() {
     ...
     while(x.next != null){
         x.next = new SListNode(x.item,x.next);
         x = x.next.next;
        }
         x.next = new SListNode(x.item,x.next);
     while(x.next !=null){
         System.out.println("Nodes are: " + x.item);
         x = x.next;
     }
  }
  }
  ...
  public static void main (String[] args) {
    ...
    testAfterInsertEnd();
    SList s = new SList();
    SListNode x = new SListNode(6);
    SListNode y = new SListNode(9);
    SListNode z = new SListNode(12);
    s.head = x;
    x.next = y;
    y.next = z;
    ...
    while ( x.next != null)
    {
     System.out.println ("Nodes are in order: " + x.item);   
    }
  }
